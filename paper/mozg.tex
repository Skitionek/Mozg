...
over SQL and MongoDB backends.  Dgraph~\cite{dgraph} is a natively
graph-oriented database that exposes a GraphQL interface.  All three
systems require the user to operate or connect to specific supported
backends; none supports the same breadth of heterogeneous
sources---including domain-specific APIs such as BioCyc, KEGG, or
OWL-described databases---that Mozg targets.
